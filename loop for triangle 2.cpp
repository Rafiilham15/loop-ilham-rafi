...
pengulangan pertama akan seperti ini
    for (int i = 1; i <= 4; i++) banyak nya pengulangan kebawah baris
    {
        for (int j =0; j < 1; j++) banyaknya pengulangan kesamping kolom
        {
        cout <<i;
        }
    }
maka hasil yang akan keluar adalah 1
...
maka hasil yang akan keluar adalah 22
...
maka hasil yang akan keluar adalah 333
...
maka hasil yang akan keluar adalah 4444
